        ...
        <ul className="getting-started-list">
          ...
          <li className="getting-started-list-item">
            <Link to="/step2" className="getting-started-link">
              2. I would like to make an offer or have a response to an offer on a home I am interested in
            </Link>
          </li>
          <li className="getting-started-list-item">
            <Link to="/step3" className="getting-started-link">
              3. I have a purchase contract and I would like help managing the escrow process
            </Link>
          </li>
          <li className="getting-started-list-item">
            <Link to="/step4" className="getting-started-link">
              4. I own the property, I would like help with next steps.
            </Link>
          </li>
        </ul>
      </Col>
